...
use Tall\Schema\DBAL\Models\DBALColumn;
use Tall\Schema\Models\Enum\Migrations\Method\ColumnType;
use Tall\Schema\Repositories\MariaDBRepository;
use Tall\Schema\Repositories\MySQLRepository;
...
class MySQLColumn extends DBALColumn
{
    ...
    /**
     * @var \Tall\Schema\Repositories\MySQLRepository
     */
    private $repository;

    /**
     * @var \Tall\Schema\Repositories\MariaDBRepository
     */
